...
- Beräkna p(4) när h = [2 5 6 9 0 0 0 0&hellip;] (h[1] = 2, h[2] = 3, osv.). Gör beräkningen för hand och rita ett träd över alla funktionsanrop. (Det går bra med ett foto på ett handritat träd.)
...
- Räkna ut en tabell över p(n) för n = 0, 1, 2, 3, 4 när h = [2 5 6 9 0 0 0 0&hellip;]. Gör beräkningen för hand.
